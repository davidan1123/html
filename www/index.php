...
function time_lapse_period()
	{
	$tl_status = "../../.dav/timelapse.status";
	$f = fopen($tl_status, 'r');
	$tl_period = 1;
	if ($f)
		{
...
<head>
  ...
  <link rel="stylesheet" href="js-css/dav.css" />
  <script src="js-css/dav.js"></script>
...
<?php
    ...
    echo "<img id=\"mjpeg_image\"
          alt=\"No preview jpeg. Is dav running?  Click: System->Start\"
